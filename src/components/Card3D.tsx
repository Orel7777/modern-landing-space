    ...
    <CardContainer className="w-full max-w-md mx-auto">
      <CardBody className="bg-white dark:from-gray-900 dark:to-black relative group/card border-2 border-[#1a56a7]/80 dark:border-white/[0.2] w-[360px] h-[480px] rounded-xl p-6 shadow-xl">
        ...
        <CardItem
          as="p"
          translateZ="60"
          className="text-[#221F26] text-base font-medium text-center mb-6"
        >
        ...
        >
          <img
            src={imageSrc}
            className="h-[280px] w-full object-cover rounded-xl group-hover/card:shadow-xl"
            alt={alt}
          />
        </CardItem>
        <div className="flex justify-between items-center mt-10">
          <CardItem
            ...
            translateX={-20}
            as="div"
            className="px-4 py-3 rounded-xl text-xs font-normal bg-white shadow-sm"
          >
          ...
          <CardItem
            ...
            translateX={20}
            as="button"
            className="px-4 py-3 rounded-xl bg-[#1a56a7] text-white text-xs font-bold hover:bg-[#15478c] transition-colors shadow-md"
