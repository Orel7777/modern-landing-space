...
export const PropertiesSection = () => {
  ...
  const allProperties: Property[] = [{
    ...
    title: "✨ למכירה בבלעדיות! דירת גן מרווחת בשכונת מורשת ✨",
    price: "₪4,200,000",
    location: "שכונת מורשת, מודיעין",
    details: "🏡 250 מ״ר | 🌳 גינה פרטית | 🚗 חניה כפולה",
    isExclusive: true
  }, {
    image: "/lovable-uploads/0afc380f-fe8f-46da-b85d-b329fdfa372a.png",
    title: "✨ למכירה בבלעדיות! דירת 3 חדרים עם גינה ✨",
    price: "₪3,900,000",
    ...
    title: "✨ למכירה בבלעדיות! דו משפחתי 5 חדרים + ממ״ד ✨",
    price: "₪5,200,000",
    location: "שכונת בוכמן, מודיעין",
    details: "🏡 180 מ״ר | 🏠 דו משפחתי | 🚗 חניה כפולה",
    isExclusive: true
  }, {
    image: "/lovable-uploads/045e09ed-69e0-4ea8-8a50-d493a011cb6b.png",
    title: "✨ למכירה בבלעדיות! דירת 6 חדרים מפוארת ✨",
    price: "₪4,500,000",
    location: "רחוב סביון, שכונת הפרחים",
    details: "🏡 200 מ״ר | 🌅 מרפסת שמש | 🚗 2 חניות",
    isSold: true,
    isExclusive: true
  }, {
    image: "/lovable-uploads/8eaad152-952f-4d2c-aac2-4b5a46173496.png",
    title: "✨ למכירה בבלעדיות! דירת 4 חדרים מרווחת ✨",
    price: "₪3,500,000",
    location: "מער",
    details: "🏡 120 מ״ר | 🌅 נוף פתוח | 🚗 חניה",
    isSold: true,
    isExclusive: true
  }, {
    image: "/lovable-uploads/96e330a2-c723-4412-885a-5e3197aae3fc.png",
    title: "✨ למכירה בבלעדיות! דירת גן 5 חדרים ✨",
    price: "₪4,800,000",
    location: "שכונת הפרחים",
    details: "🏡 150 מ״ר | 🌳 גינה פרטית | 🚗 חניה",
    isRented: true,
    isExclusive: true
  }, {
    ...
    title: "✨ למכירה בבלעדיות! וילה מפוארת 6 חדרים ✨",
    price: "₪8,500,000",
    location: "שכונת הכרמים",
    details: "🏡 350 מ״ר | 🌳 מגרש 500 מ״ר | 🚗 חניה כפולה",
    isSold: true,
    isExclusive: true
  }, {
    ...
    title: "✨ למכירה בבלעדיות! דירה בבניין בוטיק יוקרתי ✨",
    price: "₪4,100,000",
    location: "תל אביב",
    ...
    title: "✨ למכירה בבלעדיות! דירת גג מפוארת ✨",
    price: "₪3,800,000",
    location: "גבעתיים",
