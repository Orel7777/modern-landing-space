...
import RocketLoader3D from "@/components/RocketLoader3D";
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative container mx-auto">
        ...
        {/* More Properties Link with 3D Rockets */}
        <div className="flex justify-center mt-12 items-center">
          <div className="hidden md:block">
            <RocketLoader3D width="120px" height="120px" className="transform -scale-x-100" />
          </div>
          ...
          <div className="hidden md:block">
            <RocketLoader3D width="120px" height="120px" />
          </div>
        </div>
      </div>
    </section>
