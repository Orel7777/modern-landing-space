...
const Index = () => {
  ...
  return <div className="font-heebo">
      ...
      <section ref={remaxImageRef} className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#D3E4FD] via-[#E5DEFF] to-[#FDE1D3] dark:from-[#0c1d38] dark:via-[#14162f] dark:to-[#1c1835] opacity-100 transition-colors duration-300" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-right space-y-6 animate-fade-up relative z-10">
              <div className="flex justify-start">
                <SparklesText text="הנדל״ן שלך, החיים שלך" className="text-3xl md:text-4xl font-bold text-[#1a56a7] dark:text-primary bg-white/90 dark:bg-gray-900/90 py-2 rounded-lg inline-block px-4 text-right transition-colors" colors={{
                first: "hsl(var(--primary))",
                second: "hsl(var(--secondary))"
              }} sparklesCount={15} />
              </div>
              <div className="w-32 h-1 bg-gradient-to-r from-[#E5DEFF] via-[#FDE1D3] to-[#D3E4FD] dark:from-accent dark:via-secondary dark:to-primary mr-0 rounded-full transition-colors duration-300"></div>
              <p className="text-lg font-medium text-[#221F26] dark:text-gray-100 bg-white/90 dark:bg-gray-900/90 py-2 rounded-lg px-4 text-right transition-colors duration-300">המומחיות שלי היא למצוא עבורך את הנכס המושלם או למכור את הנכס שלך במחיר הטוב ביותר.</p>
              
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-3 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm transition-colors duration-300">
                  <p className="font-medium text-[#1a56a7] dark:text-primary-foreground text-right transition-colors duration-300">מציאת הבית החלומי שלך</p>
                  <div className="rounded-full bg-[#1a56a7] dark:bg-primary p-2 text-white transition-colors duration-300">
                ...
                <div className="flex items-center justify-between gap-3 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm transition-colors duration-300">
                  <p className="font-medium text-[#1a56a7] dark:text-primary-foreground text-right transition-colors duration-300">ניסיון מוכח בתחום הנדל&quot;ן </p>
                  <div className="rounded-full bg-[#1a56a7] dark:bg-primary p-2 text-white transition-colors duration-300">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                ...
                <div className="flex items-center justify-between gap-3 bg-white dark:bg-gray-800 p-3 rounded-lg shadow-sm transition-colors duration-300">
                  <p className="font-medium text-[#1a56a7] dark:text-primary-foreground text-right transition-colors duration-300">ליווי אישי לאורך כל התהליך</p>
                  <div className="rounded-full bg-[#1a56a7] dark:bg-primary p-2 text-white transition-colors duration-300">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
