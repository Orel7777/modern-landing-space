        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-center md:text-right space-y-6 animate-fade-up">
              <h2 className="text-3xl md:text-4xl font-bold text-primary">הנדל״ן שלך, החיים שלך</h2>
              <div className="w-32 h-1 bg-gradient-to-r from-[#E5DEFF] via-[#FDE1D3] to-[#D3E4FD] mx-auto md:mr-0 md:ml-auto rounded-full"></div>
              <p className="text-lg">המומחיות שלי היא למצוא עבורך את הנכס המושלם או למכור את הנכס שלך במחיר הטוב ביותר.</p>
              
              <div className="space-y-4">
                <div className="flex items-center justify-end gap-3 bg-white/80 p-3 rounded-lg shadow-sm">
                  <p className="font-medium">מציאת הבית החלומי שלך</p>
                ...
                <div className="flex items-center justify-end gap-3 bg-white/80 p-3 rounded-lg shadow-sm">
                  <p className="font-medium">נסיון רב שנים בשוק המודיעיני</p>
                  <div className="rounded-full bg-[#1a56a7] p-2 text-white">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                ...
                <div className="flex items-center justify-end gap-3 bg-white/80 p-3 rounded-lg shadow-sm">
                  <p className="font-medium">ליווי אישי לאורך כל התהליך</p>
                  <div className="rounded-full bg-[#1a56a7] p-2 text-white">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
